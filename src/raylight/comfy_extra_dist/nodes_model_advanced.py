...
# ── CFG guidance nodes (ported from comfy_extras/nodes_cfg.py) ────────


def _optimized_scale(positive, negative):
    """CFG-Zero* optimal rescale factor: st* = v_cond·v_uncond / ||v_uncond||²."""
...
class RayCFGZeroStar:
    """Raylight-compatible CFG-Zero* (https://github.com/WeichenFan/CFG-Zero-star)."""
...
class RayCFGNorm:
    """Raylight-compatible CFGNorm — rescales CFG output to match cond-only norm."""
